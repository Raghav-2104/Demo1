...
class ProductCipher{
    public static void main(String args[]){
        ...
        int n = new Scanner(System.in).nextInt();// Substitution encryption
        ...
        System.out.println("\nSubstituted text:");
        System.out.println(substitutionOutput);// Transposition encryption
        ...
        System.out.println(transpositionOutput);// Transposition decryption
